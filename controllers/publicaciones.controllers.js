import { getPublicacionesModel, AddPublicacionModel, getPublicacionByIdUsuarioModel, updatePublicacionModel, deletePublicacionModel } from '../models/publicaciones.models.js'
...
export const postAddPublicacionControllers = async (req, res) => {
    try {
        ...
        const { usuario_id, titulo, descripcion, img, precio, status } = req.body;
        if (!usuario_id || !titulo || !descripcion || !img || !precio || status === undefined) {
